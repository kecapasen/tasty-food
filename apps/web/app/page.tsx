...
import { GetGalleryDTO, GetMenuDTO, GetNewsDTO, GetSiteDTO } from "@repo/dto";
...
const Home = () => {
  ...
  return (
    <>
      ...
      {menu.data && featuredArticle && gallery.data && (
        <div className="min-h-dvh overflow-x-hidden relative">
          ...
          <div className="px-4 py-16 sm:px-16 bg-secondary">
            ...
            <div className="flex flex-col justify-start gap-4 sm:max-w-[40%]">
              ...
              <p className="text-sm">
                ...
                et quidem! Nihil deserunt voluptatem veritatis deleniti qui quae
                eos ad.
              </p>
          ...
          <div className="px-4 py-16 sm:px-16 flex justify-center items-center">
            <div className="flex flex-col justify-center items-center gap-4 text-center sm:max-w-[40%]">
              ...
              <p className="text-sm">{site.data?.data.aboutUs || ""}</p>
              <Separator className="h-[2px] w-14 bg-primary rounded-full" />
            </div>
          </div>
              ...
              >
                <CarouselContent>
                  {menu.data.data.map((item, index) => (
                    ...
                    >
                      <div>
                        <Card className="flex justify-center items-center relative z-50 h-64 aspect-square">
                          <Image
                            src={item.image}
                            alt="Dekorasi"
                            height={200}
                            ...
                            quality={100}
                          />
                          <CardContent className="h-64 aspect-square pt-[100px] flex flex-col items-center gap-4">
